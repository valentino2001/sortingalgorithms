...
public class CountingComparator<T> implements Comparator<T> {
     ...
     */
    public void reset() {
        //resetting the comparisons to zero by giving compcounter value zero
        comparisonCounter = 0;
    }
    ...
    public int compare(T o1, T o2) {
        //variable for delegation of two cards, delegate compares
        int cardDelegate = delegate.compare(o1, o2);
        //counter of comparisons +1 incrementing (counting up)
        comparisonCounter ++;
        //returning the delegation result of these two objects o1,o2
        return cardDelegate;
    }
    ...
    public int getComparisonsCount() {
        //returns number of comparisons after last reset call
